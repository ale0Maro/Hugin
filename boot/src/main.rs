...
//
//
// This file contains the main logic of the Huging Kernel Project's Bootloader
//
// The bootloader uses UEFI v0.39.0 to benefit from modern firmware features,
// including GPT disk partitioning support, a standardized 64-bit boot environment,
// and independence from legacy 16-bit BIOS real mode limitations.

#![no_std]
#![no_main]

/// Panic handler
/// defined in boot/src/panic/panic.rs
mod panic {
	mod panic;
}
...
fn main() -> Status {
	...
	uefi::println!(
		...
		boot_info.total_conventional_bytes / (1024 * 1024)
	);
